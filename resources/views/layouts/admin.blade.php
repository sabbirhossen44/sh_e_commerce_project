...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('backend')}}/assets/images/logo1.png" />
    @yield('style_content')
</head>
    ...
    <div class="main-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="advancedUI">
                            <ul class="nav sub-menu">
                                <li class="nav-item">
                                    <a href="{{route('product.add')}}" class="nav-link">Add New Product</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('product.list')}}" class="nav-link">Prodact List</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('banner')}}">
                            ...
                            <span class="link-title cursor-pointer">Banner</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('logo')}}">
                            <i class="link-icon" data-feather="life-buoy"></i>
                            <span class="link-title cursor-pointer">Logo</span>
                        </a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer d-flex flex-column flex-md-row align-items-center justify-content-between">
                <p class="text-center text-muted text-md-left">Copyright © 2025 <a href="{{route('dashboard')}}">Sabbir
                        Hossen</a>. All rights reserved</p>
