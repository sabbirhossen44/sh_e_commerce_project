            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{route('offer1.update', $offer->first()->id)}}" method="post"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mt-2">
                                    <img src="{{asset('uploads/offer/' . $offer->first()->image)}}" width="300" alt=""
                                        id="logo">
                                </div>
                                @error('image')
                                    <span class="text-danger">{{$message}}</span>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{route('offer2.update', $offer2->first()->id)}}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label for="text" class="form-label">Title</label>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mt-2">
                                    <img src="{{asset('uploads/offer/' . $offer2->first()->image)}}" width="300" alt=""
                                        id="logo2">
                                </div>
                                @error('image2')
                                    <span class="text-danger">{{$message}}</span>
